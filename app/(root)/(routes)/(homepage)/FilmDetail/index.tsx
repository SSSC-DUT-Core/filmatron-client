...
const FilmPoster = ({ posterSrc, logoSrc, title, description, rating, duration, releaseDate, genres, stars, director }: FilmPosterProps) => {
  const posterStyle = {
    ...
    <div className="relative" style={posterStyle}>
      ...
      >
        ...
        <div className='flex items-center justify-center flex-col'>
          ...
          <button
            className='filmButton info-button'
          >
            More Info
          </button>
...
const FilmCard = ({ posterSrc, title, rating, duration, isSelected, onClick }: FilmCardProps) => {
