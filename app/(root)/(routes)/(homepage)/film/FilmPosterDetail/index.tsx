...
export const FilmPosterDetail = ({ posterSrc, logoSrc, title, description, rating, duration, releaseDate, genres, stars, director, NFTClaimImg, NFTEventName, expirationDate,  trailerVideo, trailerImg, eventImg, onClick}: FilmPosterDetailProps) => {
  const posterStyle = {
