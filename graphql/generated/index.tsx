...
export type UpdateFilmDto = {
    ...
    genres?: InputMaybe<Array<FilmGenre>>;
    id: Scalars["ID"]["input"];
...
export type GetCompressedNfTsOfFilmQuery = {
    __typename?: "Query";
...
`;
export type CreateFilmMutationFn = Apollo.MutationFunction<
    CreateFilmMutation,
    CreateFilmMutationVariables
>;
...
export function useCreateFilmMutation(
    ...
    return ApolloReactHooks.useMutation<
        CreateFilmMutation,
        CreateFilmMutationVariables
    >(CreateFilmDocument, options);
}
export type CreateFilmMutationHookResult = ReturnType<
    typeof useCreateFilmMutation
>;
export type CreateFilmMutationResult =
    Apollo.MutationResult<CreateFilmMutation>;
export type CreateFilmMutationOptions = Apollo.BaseMutationOptions<
    CreateFilmMutation,
    CreateFilmMutationVariables
>;
...
export function useGetFilmsQuery(
    ...
    const options = { ...defaultOptions, ...baseOptions };
    return ApolloReactHooks.useQuery<GetFilmsQuery, GetFilmsQueryVariables>(
        GetFilmsDocument,
        options
    );
}
export function useGetFilmsLazyQuery(
    ...
    const options = { ...defaultOptions, ...baseOptions };
    return ApolloReactHooks.useLazyQuery<GetFilmsQuery, GetFilmsQueryVariables>(
        GetFilmsDocument,
        options
    );
}
 ...
 * });
 */
export function useGetCompressedNfTsOfFilmQuery(
    baseOptions: ApolloReactHooks.QueryHookOptions<
        GetCompressedNfTsOfFilmQuery,
        GetCompressedNfTsOfFilmQueryVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions };
    return ApolloReactHooks.useQuery<
        GetCompressedNfTsOfFilmQuery,
        GetCompressedNfTsOfFilmQueryVariables
    >(GetCompressedNfTsOfFilmDocument, options);
}
export function useGetCompressedNfTsOfFilmLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
        GetCompressedNfTsOfFilmQuery,
        GetCompressedNfTsOfFilmQueryVariables
    >
...
export type GetCompressedNfTsOfFilmQueryHookResult = ReturnType<
    typeof useGetCompressedNfTsOfFilmQuery
>;
export type GetCompressedNfTsOfFilmLazyQueryHookResult = ReturnType<
    typeof useGetCompressedNfTsOfFilmLazyQuery
>;
export type GetCompressedNfTsOfFilmQueryResult = Apollo.QueryResult<
    GetCompressedNfTsOfFilmQuery,
    GetCompressedNfTsOfFilmQueryVariables
>;
